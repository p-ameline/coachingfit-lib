...
public class CoachingFitLoginHeaderView extends Composite implements CoachingFitLoginHeaderPresenter.Display 
{	
	private final PrimegeViewConstants constants    = GWT.create(PrimegeViewConstants.class) ;
	private final CoachingFitConstants CF_constants = GWT.create(CoachingFitConstants.class) ;
	...
	public CoachingFitLoginHeaderView() 
	{
	...
	{
		_ErrorDialogBox.setText(CF_constants.incorrectVersionNumber() + " (votre version est la " + sClientVersion + " alors que celle du serveur est la " + sServerVersion + ")") ;
